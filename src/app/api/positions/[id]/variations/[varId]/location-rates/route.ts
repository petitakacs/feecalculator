...
export async function GET(
  ...
  const rates = await prisma.variationLocationRate.findMany({
    where: { variationId: varId },
...
export async function POST(
  ...
  const variation = await prisma.positionVariation.findUnique({ where: { id: varId } });
  ...
  const rate = await prisma.variationLocationRate.upsert({
